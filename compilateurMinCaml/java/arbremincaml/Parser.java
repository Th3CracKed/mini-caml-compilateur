...
class CUP$Parser$actions {
  ...
  public final java_cup.runtime.Symbol CUP$Parser$do_action_part00000000(
    ...
    if (e instanceof FloatMinCaml) {
        RESULT = new FloatMinCaml(-((FloatMinCaml) e).getValeur());
    } else {
        RESULT = new Neg(e);
    }
      ...
      RESULT = l; 
		...
		int eright = ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()).right;
		Exp e = (Exp)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 List l = new LinkedList<>(); l.add(0, e); RESULT = l; 
       ...
       RESULT = l; 
        ...
        List<Type> t = new LinkedList<>(); 
        t.add(0, Type.gen()); t.add(0, Type.gen());
        l.add(0, i2); 
        l.add(0, i1); RESULT = new Pair<>(l, null); 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("pat",3, ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
