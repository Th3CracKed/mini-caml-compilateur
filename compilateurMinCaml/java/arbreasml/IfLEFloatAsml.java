...
/**
 * Noeud ASML If comparant des nombres flottants avec l'opérateur inférieur ou égal
 */
public class IfLEFloatAsml extends IfFloatAsml {

    /**
     * Créé un noeud ASML correspondant à un If comparant des nombres flottants avec l'opérateur inférieur ou égal avec pour éléments comparés e1 et e2
     ...
     */
    public IfLEFloatAsml(VarAsml e1, VarAsml e2, AsmtAsml eIf, AsmtAsml eElse) {
