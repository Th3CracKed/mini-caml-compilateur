...
/**
 * Noeud ASML If comparant des nombres flottants avec l'opérateur égal
 */
public class IfEqFloatAsml extends IfFloatAsml {

    /**
     * Créé un noeud ASML correspondant à un If comparant des nombres flottants avec l'opérateur égal avec pour éléments comparés e1 et e2 et exécutant le branche eIf
