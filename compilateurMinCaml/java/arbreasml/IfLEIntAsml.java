...
/**
 * Noeud ASML If comparant des entiers avec l'opérateur inférieur ou égal
 */
public class IfLEIntAsml extends IfIntAsml {

    /**
     * Créé un noeud ASML correspondant à un If comparant des entiers avec l'opérateur inférieur ou égal avec pour éléments comparés e1 et e2 et exécutant le branche eIf
