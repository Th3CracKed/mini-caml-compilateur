...
/**
 * Noeud ASML If comparant des entiers avec l'opérateur égal
 */
public class IfEqIntAsml extends IfIntAsml {

    /**
     * Créé un noeud ASML correspondant à un If comparant des entiers avec l'opérateur égal avec pour éléments comparés e1 et e2 et exécutant le branche eIf
     ...
     */
    public IfEqIntAsml(VarAsml e1, VarOuIntAsml e2, AsmtAsml eIf, AsmtAsml eElse) {
